...
/***/ ((module) => {
    ...
    function commonAdd(x, y) { 
        console.log('common add');
        return x + y;
     }
     
     module.exports = commonAdd
     ...
     /******/ 	(() => {
     /******/ 		var inProgress = {};
     /******/ 		var dataWebpackPrefix = "compilejs:";
     ...
     /******/ 		}
     /******/ 		
     /******/ 		var chunkLoadingGlobal = self["webpackChunkcompilejs"] = self["webpackChunkcompilejs"] || [];
     ...
     console.log((0,_math_js__WEBPACK_IMPORTED_MODULE_0__.add)(11, 12));
     
     // var xxx = { a: 1, b: 2 };
     // var yyy = cloneDeep(xxx);
     // yyy.a = 5;
     // console.log(xxx);
     // console.log(yyy);
     
     // console.log(_add(11, 12))
     console.log(_common_js__WEBPACK_IMPORTED_MODULE_1___default()(11,12))
     
     __webpack_require__.e(/*! import() */ "src_data_js").then(__webpack_require__.bind(__webpack_require__, /*! ./data */ "./src/data.js")).then((mo) => {
